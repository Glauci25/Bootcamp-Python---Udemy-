...
def next_card():
    ...
    canvas.itemconfig(card_title, text="Coreano", fill="black")
    canvas.itemconfig(card_word, text=current_card["Coreano"], fill="black")
...
card_title = canvas.create_text(400, 150, text="Coreano", font=("Arial", 40, "italic"))
